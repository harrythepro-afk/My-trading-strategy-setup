...
def generate_signals(
    ...
    if sweep_mode in ["both", "double_triple"]:
    ...
    l1_low, l2_low, l3_low, l4_low = None, None, None, None
    
    short_state = "SEEK_H1"
    short_sweep_high = None
    short_trigger_level = None
    h1_high, h2_high, h3_high, h4_high = None, None, None, None
                    ...
                    if curr_low < l4_low:
                        if enable_breakout_reversal:
                            ...
                            if use_atr_tp:
                                ...
                                tp = curr_close - (atr_tp_factor * atr_val_fallback)
                            elif sltp_mode == "structure":
                                risk = sl - curr_close
                                tp = curr_close - (rr_ratio * risk)
                            else:
                                tp = curr_close * (1 - fixed_tp_pct / 100.0)
